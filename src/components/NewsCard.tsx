...
export default function NewsCard({
	...
	return (
		<div className="relative rounded-2xl border-2 border-gray-900/75 bg-gray-800 p-0 tiny:p-2 xxxs:p-3 xxs:p-4 xs:p-5 sm:p-8 lg:p-10 shadow-md h-full min-h-16 max-h-32 tiny:max-h-48 xxxs:max-h-64 xxs:min-h-32 xxs:max-h-96 xs:min-h-64 xs:max-h-96 sm:max-h-128">
